...
namespace Nop.Web.Controllers
{
    ...
    public partial class CommonController : BasePublicController
    {
        ...
        //available even when a store is closed
        [CheckAccessClosedStore(true)]
        public virtual async Task<IActionResult> WhySam()
        {
            return View();
        }
        ...
        //available even when a store is closed
        [CheckAccessClosedStore(true)]
        public virtual async Task<IActionResult> BrandIdentity()
        {
            return View();
        }

        //Personal Privacy page
        //available even when a store is closed
        [CheckAccessClosedStore(true)]
        public virtual async Task<IActionResult> PersonalPrivacy()
        {
            return View();
        }
        ...
        //available even when a store is closed
        [CheckAccessClosedStore(true)]
        public virtual async Task<IActionResult> SamService()
        {
            return View();
        }
