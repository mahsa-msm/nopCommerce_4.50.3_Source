...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : BaseRouteProvider, IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            //why sam
            endpointRouteBuilder.MapControllerRoute(name: "WhySam",
                pattern: $"{lang}/whysam",
                defaults: new { controller = "Common", action = "WhySam" });

            //brand identity
            endpointRouteBuilder.MapControllerRoute(name: "BrandIdentity",
                pattern: $"{lang}/brandidentity",
                defaults: new { controller = "Common", action = "BrandIdentity" });

            //personal privacy
            endpointRouteBuilder.MapControllerRoute(name: "PersonalPrivacy",
                pattern: $"{lang}/personalprivacy",
                defaults: new { controller = "Common", action = "PersonalPrivacy" });

            //samservice
            endpointRouteBuilder.MapControllerRoute(name: "SamService",
                pattern: $"{lang}/samservice",
                defaults: new { controller = "Common", action = "SamService" });
